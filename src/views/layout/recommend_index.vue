<template>
  <div class="recommend">
    <div class="search">
      <van-search v-model="value" placeholder="羽毛球" shape="round" background="#fff" border @click="goToSearch" />
    ...
    <div class="myrecommend">
      ...
      <div class="recommend-item " style="background-color: pink;">
      </div>
      <div class="recommend-item" style="background-color: pink;">
      </div>
      <div class="recommend-item" style="background-color: pink;">
...
.search {
  ...
  left: 0; */
  /* padding: 0 10px; */
  /* border-bottom:1px solid #4095E5; */
